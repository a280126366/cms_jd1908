...
public class ArticleController {
	...
	public Message articleDelete(Long id) {
		if(articleService.deleteById(id)==1) {
	...
	public Message findAllExtend() {
		return MessageUtil.success(articleService.findArticleExtendAll());
	}
	
	@GetMapping(value = "findArticleExdentById")
	public Message findArticleExdent(Long id) {
		ArticleExtend articleExtend = articleService.findArticleExtendById(id);
